...
The first question that might arrise is, What constitutes a symmetry? What is it?
...
In the case of clasical mechanics the main object that encapsulates the behavior 
of the system allowing for the computation of the equations of motion. Therefore 
a symmetry in clasical mechanics is any transformation to the lagrangian that 
...
called isometries. Killing fields are nothing more than the generators of 
isometries.
